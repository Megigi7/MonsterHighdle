  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content info-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p>Based on the <a href="https://monsterhigh.fandom.com/wiki/Monster_High_Wiki" target="_blank" rel="noopener noreferrer">wiki</a> G1 characters list I've put together the most popular and recognizable characters from G1, including students, teachers, and other notable characters.</p>
        ...
        <ul>
          ...
          <li><strong>Hair Color:</strong> Indicates the character's hair color or colors if it has multiple. 
            <ul style={{ marginTop: '5px', paddingLeft: '20px', fontSize: '13px', color: '#ccc' }}>
        ...
        <h4>Skullete game mode</h4>
        <p>Being shown a Skullete image, you have to guess which character it belongs to.<br/>The image is first shown with a black and white filter which can be deactivated to make the game easier.</p>
