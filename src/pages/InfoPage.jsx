...
const InfoPage = () => {
  return (
    <div className="info-page-container">
      ...
      <h2 className="info-page-title">MonsterHighdle - Rules</h2>
      <p className="info-page-subtitle">I've put together the rules I used to create the game so you can have a better gaming experience!</p>
      ...
      <div className="info-page-content">
        ...
        <p style={{ fontSize: '12px', color: '#888', marginTop: '50px', textAlign: 'center' }}>
